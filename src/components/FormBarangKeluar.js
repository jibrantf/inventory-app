    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg lg:max-w-xl transform translate-x-0 sm:translate-x-0 lg:translate-x-60 -mt-10">
        <h2 className="text-2xl font-bold text-center mb-4">
          {form.id_keluar ? 'Edit Barang Keluar' : 'Tambah Barang Keluar'}
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                disabled={form.id_keluar ? true : false} 
                required
              >
            ...
            <div>
              <label htmlFor="jumlah_keluar" className="block text-gray-900 text-sm font-semibold">Jumlah Keluar</label>
              <input
                type="number"
                id="jumlah_keluar"
                name="jumlah_keluar"
          ...
          <div className="flex justify-end mt-6">
            ...
            >
              {form.id_keluar ? 'Simpan Perubahan' : 'Tambah Barang Keluar'}
            </button>
          </div>
        </form>
      </div>
